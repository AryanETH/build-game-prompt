...
export const FeedTabs = ({ playContent, watchContent }: FeedTabsProps) => {
  return (
    <Tabs defaultValue="play" className="w-full">
      <div className="sticky top-16 md:top-0 z-40 bg-background/80 backdrop-blur-lg border-b border-border">
        <TabsList className="w-full h-14 rounded-none bg-transparent">
          <TabsTrigger 
            value="play" 

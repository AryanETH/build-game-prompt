...
BEGIN
   IF NOT EXISTS (
      ...
      WHERE policyname = 'Anyone can view comments' 
...
BEGIN
   IF NOT EXISTS (
      SELECT 1 FROM pg_policies 
      WHERE policyname = 'Authenticated users can create comments' 
        AND tablename = 'game_comments'
   ) THEN
...
BEGIN
   IF NOT EXISTS (
      ...
      ALTER TABLE public.games ADD COLUMN country TEXT;
   END IF;
   ...
   IF NOT EXISTS (
      ...
      ALTER TABLE public.games ADD COLUMN city TEXT;
   END IF;
   ...
   IF NOT EXISTS (
      ...
      ALTER TABLE public.games ADD COLUMN latitude DOUBLE PRECISION;
   END IF;
   ...
   IF NOT EXISTS (
      ...
      ALTER TABLE public.games ADD COLUMN longitude DOUBLE PRECISION;
   END IF;
END$$;
